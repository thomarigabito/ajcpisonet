...
<div class="container-fluid p-0">
    <div class="row d-flex justify-content-center">
        <div class="row p-0 py-lg-3">
            <div class="m-auto col-12 col-md-10 col-lg-6">
                <form action="{{route('applynowPOST')}}" method="POST">
            @csrf
            <div class="col-12 m-auto p-4 border rounded shadow">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 mt-md-1 p-1">
                        <input type="text" name="plan" class="form-control" value="1500" placeholder="1500" >
            ...
            <div class="col-12 col-md-12 col-lg-6  plan2 p-2">
            <div class="row my-lg-5">
                <div class="col col-md-2"><span></span></div>
                <div class="col-12 col-md-12 col-lg-4 px-2 px-md-0 py-5 text-center border-e-2 border-2 m-1 rounded-4 ">
                    <a href="{{ route('20mbps') }}">
                ...
                <div class="col-12 col-md-12 col-lg-4 px-2 py-5 text-center border-2 m-1 rounded-4">
                    <a href="{{ route('30mbps') }}">
