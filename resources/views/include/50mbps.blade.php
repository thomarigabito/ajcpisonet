    ...
    <div class="container-fluid p-0">
        <div class="row d-flex justify-content-center mt-3 mb-5">
            <div class="row">
                    ...
                    <form action="{{ route('applynowPOST') }}" method="POST">
                        ...
                        <div class="col-10 m-auto p-4 border rounded shadow">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-12 mt-md-1 p-1">
                                    <input type="text" name="plan" class="form-control" value="1300"
                                        placeholder="1300">
                ...
                <div class=" col-12 col-md-12 col-lg-6 plan2 p-0">
                    <div class="row my-lg-5">
                        ...
                        <div class="col-12 col-md-12 col-lg-4 px-2 px-md-0 py-5 text-center border-2 m-1 rounded-4">
                            <a href="{{ route('30mbps') }}">
