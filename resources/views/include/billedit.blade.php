                    ...
                    <div class="card-body">
                        <form action="{{route('billupdate',[
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="january" class="form-control" name="january" value="{{$BillEdit->january}}" />
                                @error('january') <span class="text-danger">{{$message}}</span>@enderror
                            </div>
                            @endif
                            @if(date('m')>=2)
                            <div class="mb-3">
                                <label  for="february">Febuary</label>
                                <input type="text" id="february" class="form-control" name="febuary" value="{{$BillEdit->febuary}}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="march" class="form-control" name="march" value="{{$BillEdit->march}}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="april" class="form-control" name="april" value="{{$BillEdit->april}}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="may" class="form-control" name="may" value="{{$BillEdit->may}}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="june" class="form-control" name="june" value="{{$BillEdit->june}}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="july" class="form-control" name="july" value="{{$BillEdit->july}}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="august" class="form-control" name="august" value="{{$BillEdit->august}}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="september" class="form-control" name="september" value="{{$BillEdit->september}}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="october" class="form-control" name="october" value="{{$BillEdit->october}}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="november" class="form-control" name="november" value="{{$BillEdit->november}}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="december" class="form-control" name="december" value="{{$BillEdit->december}}" />
