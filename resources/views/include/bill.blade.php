                ...
                <div class="p-4 text-gray-900">
                   ...
                   <div class="card">
                    <div class="card-header ">
                        <h4 style="text-transform: capitalize; font-size:10px">{{$fullname}}
                            <a href="{{route('admindashboard')}}" class="btn btn-primary float-end mx-1 billicon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-circle" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-4.5-.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5z"/>
                                </svg>
                            </a>
                            <a href="{{url('clients/'.$client_id.'/billedit')}}" class="btn btn-success float-end billicon">
                            ...
                            class="btn btn-danger float-end mx-1 billicon" onclick="sendEmail()" >
