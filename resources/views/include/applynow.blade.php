                        ...
                        <form action="{{ route('applynowPOST') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-10 m-auto p-4 border rounded shadow">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 mt-md-1 p-1">
                                        <input type="text" name="middlename" class="form-control"
                                            placeholder="Middle Name" style="text-transform:capitalize" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 mt-md-1 p-1">
                                        <input type="text" name="province" class="form-control"
                                            placeholder="Province" style="text-transform:capitalize" />
                                ...
                                <div class="row">
                                    <div class="col mt-md-1 p-1">
                                        <input type="text" name="landmark" class="form-control"
                                            placeholder="Landmark" style="text-transform:capitalize" />
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-lg-6 col-md-12 mt-md-1 p-1">
                                        <button type="submit"
                                            class="form-control btn btn-primary text-dark">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </form>
