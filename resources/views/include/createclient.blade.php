                    ...
                    <div class="card-body">
                        <form action="{{route('storeclient')}}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control uppercase" name="fullname" value="{{old('name')}}" style="text-transform:capitalize"  />
                                @error('fullname') <span class="text-danger">{{$message}}</span>@enderror
                            </div>
                            <div class="mb-3">
                                <label>Address</label>
                                <input type="text" class="form-control uppercase" name="address" value="{{old('address')}}" style="text-transform:capitalize"  />
