                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 align-items-end">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12 col-lg-4 col-md-6 flex-col-reverse bg-white overflow-hidden shadow-sm sm:rounded-lg ">
                                        <div id="soa">
                                            <div class="logobill">
                                                <img src="/assets/agclogo.png" alt="BillLogo" width="80px"
                                                    height="40px">
                                            </div>
                                            <h6 class="text-center uppercase p-0 m-0">
                                                Statement of account
                                            </h6>
                                            <p class="p-0 m-0 text-center" style="font-size: 10px; font-style:italic">
                                                Zone 7,
                                            ...
                                            <div class="soa responsive-table">
                                                <table class="table table-bordered table-sm " style="font-size: 12px">
                                                    ...
                                                    <tr class="text-nowrap">
                                                        <td id="due" class="bg-danger text-light">Bill Due Date
                                                        </td>
                                                    ...
                                                    <tr style="border:transparent">
                                                        ...
                                                        <td
                                                            style="border:none; border-bottom:1px solid black; width:50%">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        @if (date('m') == 1)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $total - $january }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 2)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $total - $febuary }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 3)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $total - $march }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 4)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $total - $april }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 5)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $total - $may }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 6)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $total - $june }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 7)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $total - $july }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 8)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $total - $august }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 9)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369;
                                                                {{ $total - $september }}.00</td>
                                                        @endif
                                                        @if (date('m') == 10)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $total - $october }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 11)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369;
                                                                {{ $total - $november }}.00</td>
                                                        @endif
                                                        @if (date('m') == 12)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369;
                                                                {{ $total - $december }}.00</td>
                                                        @endif
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        @if (date('m') == 1)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $january }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 2)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $febuary }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 3)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $march }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 4)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $april }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 5)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $may }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 6)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $june }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 7)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $july }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 8)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $august }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 9)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $september }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 10)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $october }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 11)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $november }}.00
                                                            </td>
                                                        @endif
                                                        @if (date('m') == 12)
                                                            <td style="border:none; border-bottom:1px solid black;"
                                                                class="text-nowrap">&#8369; {{ $december }}.00
                                                            </td>
                                                        @endif
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="mx-2 py-2 flex">
                                            <svg onclick="printTable('soa')" class="cursor-pointer" width="16"
                                                ...
                                                class="px-1 mb-1 cursor-pointer" style="font-size: 12px">Print
                                                Reciept</span>
                                        </div>
                                ...
                                <div class="col-12 col-lg-8 col-md-12 ">
                                    <div class="container pt-5">
                                        <div class="row gx-3 justify-content-between">
                                                <div class="promo-card  col-md-12 col-lg-6 col-xl-6  py-sm-2 rounded">
                                                    <div class="p-2 rounded-lg shadow-lg m-1">
                                                        ...
                                                        <div class="mb-10 pt-3">
                                                            <small class="fw-bold">Effortless Internet Access for Your
                                                                Daily Needs</small>
                                                            <p class="fw-light opo">•<small> Dive into all your online
                                                                    passions effortlessly.</small>
                                                            </p>
                                                            <p class="fw-light opo">•<small> Designed for small
                                                                    households to enjoy seamless access to
                                                ...
                                                <div class="promo-card col-md-12 col-lg-6 col-xl-6 py-sm-2 rounded">
                                                    <div class="p-2 rounded-lg shadow-lg m-1">
                                                        ...
                                                        <div class="mb-10 pt-3">
                                                            <small class="fw-bold">Effortless Internet Access for Your
                                                                Daily Needs</small>
                                                            <p class="fw-light opo">•<small> Seamlessly indulge in all
                                                                    your online activities</small>
                                                            </p>
                                                            <p class="fw-light opo">•<small> Specially designed for
                                                                    small households, ensuring steady
                                                ...
                                                <div class="promo-card col-md-12 col-lg-6 col-xl-6 py-sm-2 rounded">
                                                    <div class="p-2 rounded-lg shadow-lg m-1">
                                                        ...
                                                        <div class="mb-10 pt-3">
                                                            <small class="fw-bold">Premium Internet Experience for
                                                                Enhanced Connectivity</small>
                                                            <p class="fw-light opo">•<small> Engage in all your online
                                                                    passions effortlessly.</small>
                                                            </p>
                                                            <p class="fw-light opo">•<small> Tailored for small
                                                                    households,</small></p>
                                                ...
                                                <div class="promo-card col-md-12 col-lg-6 col-xl-6 py-sm-2 rounded">
                                                    <div class="p-2 rounded-lg shadow-lg m-1">
                                                        ...
                                                        <div class="mb-10 pt-3">
                                                            <small class="fw-bold">High-Performance Streaming and
                                                                Gaming</small>
                                                            <p class="fw-light opo">•<small> Dive into your online world
                                                                    effortlessly with
                                                                    lightning-fast speeds.</small></p>
                                                            <p class="fw-light opo">•<small> Designed for households
                                                                    craving</small></p>
